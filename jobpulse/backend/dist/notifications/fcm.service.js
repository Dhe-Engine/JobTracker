...
async function sendToUser(userId, message) {
    ...
    if (!tokens || tokens.length === 0) {
        ...
        logger_1.logger.info("No FCM tokens found for user", {
            userId,
        });
        return false;
    }
    ...
    if (staleTokenIds.length > 0) {
        ...
        logger_1.logger.info("Removed stale FCM tokens", {
            userId,
