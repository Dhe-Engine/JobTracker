...
*/
async function getMotivationQuote(tone, context) {
...
*/
async function generateQuoteWithGemini(tone, context) {
    ...
    if (context?.appliedToday !== undefined && context?.effectiveTarget !== undefined) {
        ...
        const progressPct = context.effectiveTarget > 0 ? Math.round((context.appliedToday / context.effectiveTarget) * 100) : 0;
        situationLine = `
